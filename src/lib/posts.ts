...
export const posts: Post[] = [
  {
    ...
    dek: "USDT is the world's most-used stablecoin, designed to hold a stable value tied to the US dollar. USDT on TON brings it inside Telegram: instant transfers, near-zero fees, and no bank in the middle.",
